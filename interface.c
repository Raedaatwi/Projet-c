...
create_window1 (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), scrolledwindow1, 104, 32);
...
create_window2 (void)
{
  ...
  d_adj = gtk_adjustment_new (1, 1, 24, 1, 10, 10);
  d = gtk_spin_button_new (GTK_ADJUSTMENT (d_adj), 1, 0);
  gtk_widget_show (d);
  gtk_fixed_put (GTK_FIXED (fixed2), d, 168, 248);
  ...
  appliquer = gtk_button_new_with_mnemonic ("Appliquer");
  gtk_widget_show (appliquer);
  gtk_fixed_put (GTK_FIXED (fixed2), appliquer, 344, 400);
  gtk_widget_set_size_request (appliquer, 88, 32);

  quitter = gtk_button_new_with_mnemonic ("Quitter");
  gtk_widget_show (quitter);
  gtk_fixed_put (GTK_FIXED (fixed2), quitter, 504, 400);
  gtk_widget_set_size_request (quitter, 88, 32);

  afficher = gtk_button_new_with_mnemonic (_("Afficher"));
  gtk_widget_show (afficher);
  gtk_fixed_put (GTK_FIXED (fixed2), afficher, 88, 400);
  ...
  label6 = gtk_label_new (_("dur\303\251e/h"));
  gtk_widget_show (label6);
  gtk_fixed_put (GTK_FIXED (fixed2), label6, 40, 248);
  gtk_widget_set_size_request (label6, 80, 24);

  prix = gtk_entry_new ();
  gtk_widget_show (prix);
  gtk_fixed_put (GTK_FIXED (fixed2), prix, 416, 256);
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), label15, 344, 256);
  ...
  GLADE_HOOKUP_OBJECT (window2, d, "d");
