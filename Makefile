...
pkgdatadir = $(datadir)/vol
pkgincludedir = $(includedir)/vol
pkglibdir = $(libdir)/vol
pkglibexecdir = $(libexecdir)/vol
...
am_vol_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) interface.$(OBJEXT) \
	callbacks.$(OBJEXT) vol.$(OBJEXT)
vol_OBJECTS = $(am_vol_OBJECTS)
am__DEPENDENCIES_1 =
vol_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
ACLOCAL = ${SHELL} /home/dhya/vol/vol/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/dhya/vol/vol/missing autoconf
AUTOHEADER = ${SHELL} /home/dhya/vol/vol/missing autoheader
AUTOMAKE = ${SHELL} /home/dhya/vol/vol/missing automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/dhya/vol/vol/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/dhya/vol/vol/src
abs_srcdir = /home/dhya/vol/vol/src
abs_top_builddir = /home/dhya/vol/vol
abs_top_srcdir = /home/dhya/vol/vol
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/dhya/vol/vol/install-sh
...
vol_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
vol$(EXEEXT): $(vol_OBJECTS) $(vol_DEPENDENCIES) $(EXTRA_vol_DEPENDENCIES) 
	@rm -f vol$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(vol_OBJECTS) $(vol_LDADD) $(LIBS)
